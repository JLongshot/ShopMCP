...
1. Human tells their agent "go shop theagentcatalog.com" (or similar).
...
`/` is the landing page. Copy leans into "this store is not for you, it is for your agent." The hero is a prompt the user can paste into any AI chat: "Go shop theagentcatalog.com for me." A short explainer, product list, and FAQ sit below.
